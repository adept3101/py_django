...
from .decorators import permission_id_required

@permission_id_required(105, 106, 107)
def unified_feeds_view(request):
    user_perm_ids = request.user.user_permissions.values_list('id', flat=True)

    context = {
        'has_fincert': 106 in user_perm_ids,
        'has_mvd': 105 in user_perm_ids,
        'has_ioc': 107 in user_perm_ids,
    }
